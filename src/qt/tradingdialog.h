...
private slots:
    ...
    void on_BuyTheresaMay_clicked();
    void on_SellTheresaMayBTN_clicked();
    void on_SellBidcomboBox_currentIndexChanged(const QString &arg1);
    void on_Sell_Max_Amount_clicked();
    void on_UnitsInputTheresaMay_textChanged(const QString &arg1);
    ...
    QString BuyTheresaMay(QString OrderType, double Quantity, double Rate);
    QString SellTheresaMay(QString OrderType, double Quantity, double Rate);
